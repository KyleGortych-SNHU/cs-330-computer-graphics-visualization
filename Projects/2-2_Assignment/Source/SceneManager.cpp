...
void SceneManager::RenderScene()
{
  ...
  // z edited for pointing pyramid down
  // a edited for rotaing the 3d priamid to show its face head on
  ...
  // new position above the origin
  positionXYZ = glm::vec3(0.0f, 0.55f, 0.0f);
  ...
  // Bottom pyramid section
	...
	// set the XYZ rotation for the mesh
  // changed to rotate 180 for z axis to invert
	XrotationDegrees = -30.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;

	// set the XYZ position for the mesh
  // changed to be below the origin
	//positionXYZ = glm::vec3(2.0f, 0.0f, 0.0f);
	positionXYZ = glm::vec3(0.0f, -0.55f, 0.0f);
